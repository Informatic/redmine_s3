...
RedminePluginSupport::Base.setup do |plugin|
  ...
  # TODO: gem not getting this automatically
...
begin
  ...
  Jeweler::Tasks.new do |s|
    s.name = "redmine_s3"
    s.summary = "Plugin to store file on s3"
    s.email = "michael@mac4u.tech"
    s.homepage = "https://mac4u.tech"
    s.description = "Plugin to store files on s3"
    s.authors = ["0x2c4"]
...
# TODO: extract to the redmine_plugin_support gem
namespace :db do
